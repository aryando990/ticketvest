...
<section class="slider-banner-area clearfix">
    ...
    <div class="banner-left floatleft">
        ...
        <div class="slider-banner">
            <div class="single-banner tiara">
                <a class="/nbanner-thumb" href="#"><img src="/annprint/Neck.jpg"
                        alt="" /></a>
            </div>
            <div class="single-banner banner-2">
                <a class="banner-thumb" href="#"><img src="/annprint/Starboy.jpg"
                        alt="" /></a>
            </div>
        </div>
        <!-- Slider-banner end -->
        ...
        <div class="slider-area">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides">
                    <img src="/annprint/haha.jpg" alt="" title="#haha-direction-1" />
                    <img src="/annprint/hehe.jpg" alt="" title="#hehe-direction-2" />
                    <img src="/annprint/huhu.jpg" alt="" title="#huhu-direction-3" />
                </div>
                <!-- direction 1 -->
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                                    <h2 class="slider-title3 text-uppercase mb-0" style="color:rgb(18, 3, 3)">Selamat
                                        Datang Di </h2>
                                </div>
                                <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay="2.5s">
                                    <h3 class="slider-title2 text-uppercase" style="color:white">Ticketvest
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                <div class="wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <h2 class="slider-title1 text-uppercase">Ticketvest</h2>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title-border">Top Artis</h2>
                </div>
