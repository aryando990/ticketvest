                    ...
                    <div class="single-product clearfix">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <p>
                                    {{ $detail->nama_produk }} merupakan penyanyi terkenal, {{ $detail->nama_produk }} juga merupakan seniman musik dan penulis musik 
                                </p>
                                <p>
                    ...
                    <div class="col-md-3">
                        <div class="single-pro-tab-menu">
                            ...
                            <ul class="nav d-block">
                                <li><a class="active" href="#description" data-bs-toggle="tab">Deskripsi Tiket</a></li>
