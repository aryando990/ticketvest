        ...
        <div class="page-content-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Form Upload Tiket</h4>
                            ...
                            <form action="{{ route('produk.update', $produk->id_produk) }}" method="post"
                                ...
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Deskripsi Konser</label>
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-success w-100"><i
                                            class="mdi mdi-content-save"></i> Perbaharui Tiket</button>
                                </div>
                            </form>
                        </div>
                    </div>
