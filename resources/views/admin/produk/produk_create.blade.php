        ...
        <div class="page-content-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Form Upload Tiket Baru</h4>
                            <form action="{{ route('produk.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Nama Tiket</label>
                                    <input
                                ...
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Kategori Tiket</label>
                                    <select class="form-control select2  @error('pilih_kategori') is-invalid @enderror" name="pilih_kategori">
                                        <option selected disabled value="">--- Pilih Kategori Tiket ---</option>
                                ...
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Foto Tiket</label>
                                    <div class="row">
                                        <div class="col-md-3">
                                ...
                                <hr>
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Daftar Harga Tiket</label>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label for="validationCustom01" class="form-label">Festival</label>
                                        ...
                                        <div class="col-md-2">
                                            <label for="validationCustom01" class="form-label">Reguler</label>
                                            <input id="input-currency" class="form-control input-mask text-left"
                                                name="harga_produk2"
                                                data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': 'Rp. ', 'placeholder': '0'">
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <label for="validationCustom01" class="form-label">VVIP</label>
                                            <input id="input-currency" class="form-control input-mask text-left"
                                                name="harga_produk4"
                                                data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': 'Rp. ', 'placeholder': '0'">
                                        </div>
                                        <div class="col-md-2">
                                            <label for="validationCustom01" class="form-label">VVIP 1</label>
                                            <input id="input-currency" class="form-control input-mask text-left"
                                                name="harga_produk5"
                                                data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': 'Rp. ', 'placeholder': '0'">
                                        </div>
                                ...
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Deskripsi Tiket</label>
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-success w-100"><i class="mdi mdi-content-save"></i> Simpan Tiket</button>
                                </div>
                            </form>
                        </div>
                    </div>
