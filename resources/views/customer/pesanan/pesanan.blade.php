                            ...
                            <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#profile1" role="tab">
                                        ...
                                        <span class="d-none d-sm-block">Pesanan Tiket</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#messages1" role="tab">
                                        <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                        <span class="d-none d-sm-block">Konfirmasi Tiket</span>
                                    </a>
                                </li>
                            </ul>
                                            ...
                                            <tbody>
                                                @foreach ($ongoing as $ongoing)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            {{ $ongoing->quantity }} tiket
                                                        </td>
                                                        <td>
                                                            @if ($ongoing->tipe_pembayaran == 'lunas')
                                                                <div class="badge badge-soft-success font-size-12">Pesanan Sedang di tinjau</div>
                                                            @endif
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <p class="card-title-desc">Bukti Pembayaran </p>
                                                                    <dl class="row mb-0">
                                                        ...
                                                        <td>
                                                            <a href="" class="me-3 text-success"
                                                                ...
                                                                data-bs-target="#komentar-{{ $kirim->id_pesanan }}"><i
                                                                    class="mdi mdi-fast font-size-18"></i> Terima </a>
                                                        </td>
                                                    </tr>
                                                                    ...
                                                                    <form action="{{ route('customer.store_komentar') }}"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xl-12 mb-2">
                                                                                <label for="">Komentar
                                                                                    Produk</label>
                                                                                <textarea class="form-control" name="komentar" id="" cols="30" rows="10">Tiket Memuaskan Sekali</textarea>
                                                                            </div>
                                                                            <div class="col-xl-12 mb-2">
                                                                                <button type="submit"
