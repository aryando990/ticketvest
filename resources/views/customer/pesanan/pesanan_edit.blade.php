                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Informasi Tagihan Pembayaran Untuk Pembelian Tiket</p>
                            <hr>
                            <p class="card-title-desc">Metode Pembayaraan</p>
                            <div class="row">
                                @foreach ($ongkir as $ongkir)
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="card border rounded shipping-address">
                                            <div class="card-body">
                                                <img src="/annprint/bca.jpg" width="60" height="60">
                                                <div class="mb-1">
                                                    <input type="radio">
                                ...
                                <div class="col-lg-8 col-sm-6">
                                    <div class="card border rounded shipping-address">
                                        <div class="card-body">
                                            <h4 class="card-title font-size-16 mt-0">Lokasi Penerima : </h4>
                                            <p class="card-text">
                                                {{ Str::title($pesanan->alamat . ', ' . $pesanan->nama_kota . ' [ ' . $pesanan->nama_prov . ']') }}
                                            </p>
                                            <p class="card-text"><b>Penerima Tiket</b></p>
                                ...
                                <table class="table mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0" scope="col">Tiket</th>
