        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('customer.dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="/morvin/dist/assets/images/tiket.png" alt="" height="120">
                    </span>
                    <span class="logo-lg">
                        <img src="/morvin/dist/assets/images/tiket.png" alt="" height="100">
                    </span>
                </a>

                <a href="{{ route('customer.dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="/morvin/dist/assets/images/tiket.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="/morvin/dist/assets/images/tiket.png" alt="" height="20">
                    </span>
                </a>
            </div>
                            ...
                            <a href="{{ route('pesanan.index') }}" class="text-reset notification-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6 class="mt-0 mb-1">Tiket Anda Dalam Pengecekan</h6>
                                        <div class="font-size-13 text-muted">
                                            <p class="mb-1">{{ $notif_topnav_pesanan_dikirim->count() }} Pesanan Dalam Proses</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
