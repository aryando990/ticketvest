                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Tiket Details </li>
                        </ol>
                    </div>
                </div>
            </div>
                                        ...
                                        <form action="{{ route('keranjang.store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mt-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="demo0" type="text" value="Festival" name="demo0"
                                                        data-bts-min="Festival" data-bts-max="VVIP 1" data-bts-init-val=""
